    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Motorcycle motorcycle = new Motorcycle() { HasSideCar = true, Make = "Harley", Model = "Chopper", Year = 1997 };

            Vehicle sedan = new Car() { HasTrunk = true, Make = "Nissan", Model = "Altima", Year = 2015 };
            Vehicle sport = new Car() { HasTrunk = true, Make = "Ford", Model = "Mustang", Year = 2020 };
